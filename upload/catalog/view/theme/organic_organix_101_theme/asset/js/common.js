...
$(document).ready(function() {
    ...
    $(".text-danger").each(function() {
        ...
        2 == e ? $("#content .product-list").attr("class", "product-layout product-grid col-lg-6 col-md-6 col-sm-12 col-xs-12") : 1 == e ? $("#content .product-list").attr("class", "product-layout product-grid col-lg-3 col-md-3 col-xl-3 col-sm-6 col-xs-12") : $("#content .product-list").attr("class", "product-layout product-grid col-lg-3 col-md-3 col-sm-6 col-xs-12"), $("#list-view").removeClass("active"), $("#grid-view").addClass("active"), localStorage.setItem("display", "grid"), t()
            ...
            e = $("#cart_quantity" + t).val(), $.ajax({
                ...
                success: function(t) {
                    if ($(".alert-dismissible, .text-danger").remove(), t.redirect && (location = t.redirect), t.success) {
                        var price = "<span class='price'>" + t.price + "</span>";
                        if (t.special) {
                            price = "<span class='price'>" + t.special + "</span><span class='regular-price'>" + t.price + "</span>";
                        }
                        var e = "<div class='badcategory-add-to-cart-inner'><div class='badcategory-add-to-cart-img-block'><img src='" + t.image + "'></div><div class='badcategory-add-to-cart-img-content'><h1><a href='" + t.link + "'>" + t.name + "</a></h1><div class='badproduct-price-and-shipping'>" + price + "</div></br><a href='" + t.cartlink + "'><div class='badcategory-add-to-cart-button'>View cart</div></a></div></div>";
                        $.fancybox.open([{
                            type: "inline",
                            autoScale: !0,
                            minHeight: 30,
